...
public class TVShowAdpters extends RecyclerView.Adapter<TVShowAdpters.TVShowViewHolder> {
    private LayoutInflater layoutInflater;
    private List<TVShow> tvShows;
    private TVShowsListener tvShowsListener;


    public TVShowAdpters(List<TVShow> tvShows,TVShowsListener tvShowsListener) {
